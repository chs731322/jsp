		 ...
		 <c:forEach var="comment" items="${commentList }">
		 	<div class="comment">
		 		<p>
		 			...
		 			<span><a href="#" class="btn_comment_like">좋아요 : <span id="comment_like_count">${comment.clike }</span></a></span>
		 			<span><a href="#" class="btn_comment_hate">싫어요 : <span id="comment_hate_count">${comment.chate}</span></a></span>
		 		</p>
		 		<p>${comment.content }</p>
