...
<%
request.setAttribute("id", "12341234");
...
<body>
	<form action="updateProfile.do" method="get">
		<input type="hidden" name="memberNum" value="A00004"> <input
			type="hidden" name="id" value="12341234"> <input type="hidden"
			name="password" value="1234">
		<button type="submit">테스트로 마이페이지 열기</button>
	</form>
		...
		<div class="container">
			...
			<div class="main-content">
				...
				<div class="form-section">
					...
					<label for="birth">생년월일</label> <input type="date" id="birth" name="birth"
